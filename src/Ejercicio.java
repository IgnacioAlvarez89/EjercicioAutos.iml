...
public class Ejercicio {
      ...
      * @exception NullPointerException enseña error al ingreso de datos no estipulado, numericos o alfabeticos, no puede exceder las fechas de 1990 al año actual,
      * solo se aceptan los colores de la lista, solo los autos de la lista,y solo si el auto tiene velocidad crucero (aceptando solo las sentencias "Si" y "No")
      * @see Auto
     */
   public static ArrayList<Auto> creacionAutos() {
         /* Uso de ArrayList para almacenar objetos, en este caso  primitivos esto se puede notar en el booleano, en el int para el uso de numeros enteros
         dado que es de almacenamiento dinamico
          */
        ...
        /* Se utilizo $ para representar el final de la cadena y ^ para representar el inicio de la misma, el | para indicar varias opciones

        * tambien se le añadio () para la busqueda opcional que le permite buscar indicaciones*/
        /* Y un NullPointerException para que muestre el mensaje "El año de fabricacion debe ser entre 1990 y año actual."
        si el dato ingresado no es el correspondiente al que se le ofrece*/
       ...
       if(userIn2.matches("^[1]+[9]+[9]+[0-9]$") || userIn2.matches("^[2]+[0]+[0-2]+[0-9]$")
        ...
        /* Expresion Regular  se utilizo + para que se encuentre una cadena repetida*, se utilizo \n para representar una nueva linea */
        ...
        /*Se utilizo equalsIgnoreCase para diferenciar  los strings, y devolver true o false*/
